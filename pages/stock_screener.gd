...
func _ready():
    ...
    GameState.current_day.delayed_action_taken.connect(_populate_data)
...
func _populate_data() -> void:
    ...
    GainLossValueLabel.text = Helpers.currencyify(GameState.portfolio.total_delta(stock.ticker_symbol), true)
